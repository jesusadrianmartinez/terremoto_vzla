  ...
  return (
    <section id="about" className="py-8 md:py-10 bg-[#fcfbf7]">
      <div className="container-page px-4 grid gap-6 md:grid-cols-12 items-stretch">
        ...
        {/* Mi Historia */}
        <div className="md:col-span-6 sm:border-x border-navy/10 px-0 md:px-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="sm:col-span-1 grid grid-cols-1 gap-2 self-center">
            <Image
              src="/about.png"
              alt={currentStory.altImage1 || ""}
              width={0}
              height={0}
          ...
          <div className="sm:col-span-2 flex flex-col justify-center">
            ...
            <div className="text-xs leading-relaxed text-navy/80 space-y-2">
              ...
              {currentStory.details?.map((detail, idx) => (
                <p
                  key={idx}
                  className={idx === 0 ? "line-clamp-4" : "line-clamp-3"}
                >
                  {detail}
                </p>
              ))}
